...
# Read in rows from the file from the 'data' folder in the working directory
...
# Remove columns/attribute not included in p (part 1 just uses 'RedMeat' and 'WhiteMeat' attributes)
